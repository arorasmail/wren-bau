...
export const typeDefs = gql`
  ...
  type FinancialSummary {
    totalCasaBalance: Float!
    totalFdValue: Float!
    totalRdValue: Float!
    totalInvestmentValue: Float!
    totalCreditLimit: Float!
    totalCreditOutstanding: Float!
  ...
  type Query {
    ...
    # biu-agent queries
    getCustomerDashboard(customerId: String!): CustomerDashboard
    getCustomerProfile(customerId: String!): CustomerProfile
    getFinancialSummary(customerId: String!): FinancialSummary
    getRecentActivity(customerId: String!, limit: Int): [Activity!]!
    getAccountOverview(customerId: String!): [Account!]!
    getProductHoldings(customerId: String!): [Product!]!
    getCreditCardSummary(customerId: String!): CreditCardSummary
