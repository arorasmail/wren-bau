...
import { BiuAgentResolver } from './resolvers/biuAgentResolver';
...
const biuAgentResolver = new BiuAgentResolver();
const resolvers = {
  JSON: GraphQLJSON,
  ...
  Query: {
    ...
    // biu-agent queries
    getCustomerDashboard: biuAgentResolver.getCustomerDashboard,
    getCustomerProfile: biuAgentResolver.getCustomerProfile,
    getFinancialSummary: biuAgentResolver.getFinancialSummary,
    getRecentActivity: biuAgentResolver.getRecentActivity,
    getAccountOverview: biuAgentResolver.getAccountOverview,
    getProductHoldings: biuAgentResolver.getProductHoldings,
    getCreditCardSummary: biuAgentResolver.getCreditCardSummary,
    getInvestmentData: biuAgentResolver.getInvestmentData,
    searchCustomers: biuAgentResolver.searchCustomers,
    getAllCustomerIds: biuAgentResolver.getAllCustomerIds,
    chatQuery: biuAgentResolver.chatQuery,
  },
  Mutation: {
